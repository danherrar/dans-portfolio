  ...
  return (
    <section id="contact" className="py-20 text-center border-t-4 border-secondary mt-12">
      ...
      <div className="mt-12 flex justify-center gap-8">
        <Link href="https://github.com/dherrarte" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
          <Github className="h-10 w-10" />
           <span className="sr-only">GitHub</span>
        </Link>
        <Link href="https://www.linkedin.com/in/daniel-herrarte/" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
